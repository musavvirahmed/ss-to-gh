#!/usr/bin/env python3
"""PROTOTYPE server — tier C eyes / atlas portrait in homepage bio layout."""
...
def main():
    ...
    try:
        ...
        raise
    print(
        f"Tier C prototype http://{args.bind}:{args.port}/ "
        f"(?variant=A eyes / ?variant=B atlas; site assets at /site/…)"
    )
    httpd.serve_forever()
