#!/usr/bin/env python3
"""PROTOTYPE server — pixel sunglasses hover on tier-C interactive portrait."""
...
def main():
    ...
    try:
        ...
        raise
    print(
        f"Pixel-sunglasses prototype http://{args.bind}:{args.port}/ "
        f"(?variant=A|B|C; site assets at /site/…)",
        flush=True,
    )
    httpd.serve_forever()
