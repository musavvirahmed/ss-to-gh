...
I used to pay Squarespace on the order of **€132 annually**, to park a one-page personal site - because it was extremely convenient, I did not have to think about anything. I always wanted out. I wanted the same site, with near-zero costing. But I could find neither the time nor the energy to create an exit plan or an alternative stack.
...
**Outcome:** [musavvir.info](https://musavvir.info/) still looks like its former Squarespace-self. Its hosting cost beyond the domain is effectively €0 (thanks to Cloudflare Pages). And the expensive Squarespace subscription liability is gone.
