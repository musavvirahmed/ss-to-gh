...
Build helpers, smoke checks, and unit tests for the static site.

Edit copy in [`content/`](../content/). These scripts bake that copy into `public/` and check the result.
